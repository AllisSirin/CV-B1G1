...
- Auto refresh: `.github/workflows/pages.yml` builds a snapshot once a day, right after midnight JST (00:03, three minutes of slack since the exact hour gets crowded on GitHub's schedulers) and publishes it to GitHub Pages. Free for public repositories.
